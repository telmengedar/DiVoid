...
22 tools currently registered (see `src/divoid_mcp/tools/__init__.py`). Read-side: `divoid_search`, `divoid_get_node`, `divoid_get_content`, `divoid_get_links`, `divoid_list` (aka list_nodes), `divoid_download_content`. Mutate: `divoid_link_nodes`, `divoid_unlink_nodes`, `divoid_patch_node`, `divoid_patch_link`, `divoid_set_status`, `divoid_set_content`, `divoid_edit_content`, `divoid_delete_node`. Composite create: `divoid_create_task`, `divoid_create_documentation`, `divoid_create_session_log`, `divoid_create_node` (generic escape hatch for any type). Messaging: `divoid_send_message`, `divoid_list_messages`, `divoid_delete_message`, `divoid_resolve_user`.
